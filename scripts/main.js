;(function (window) {
  ...
  let texts = ['KLIK DIMANA AJA SAYANG :)','JANGAN LUPA YA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT', 'KATA INI', 'KAYAKNYA ADA YANG ANEH', 'AYO PENCET LAGI', 'AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAU KAMU PASTI KESEL', 'TAPI INI BENERAN ADA YANG ANEH', 'AKU JANJI', 'INI YANG TERAKHIR', 'PENCET LAGI', 'AYO SEMANGAT ^^', 'KAMU PASTI BISA !', 'IHHH KAMU KURANG PENCET ITU', 'AYO DONG HAHA', 'IYA INI BENER TERAKHIR KOK', 'YAUDAH..', 'I', 'LOVE', 'YOU ♡', 'BIDADARIKU', 'YOLLA FEBYA', 'MAAFIN AKU YA', 'LOPYU POREPER']
